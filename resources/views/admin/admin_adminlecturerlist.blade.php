                ...
                <section class="section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="buttons" style="text-align: right;">
                                    <a href="{{ route('admin.adminlecturer_create') }}"
                                        class="btn btn-primary bg-blue">Add
                                        new users</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover bdr">
                            <thead class="bg-blue">
                                <tr>
                                    <th scope="col" class="text-bold-700">No</th>
                            ...
                            <tbody class="bg-white">
                                @foreach ($users as $user)
                                    @if ($user->roles_id === 1 || $user->roles_id === 2)
                                        <tr>
                                            <td class="text-bold-700">{{ $user->id }}</td>
                                            <td>{{ $user->name }}</td>
                                            <td>{{ $user->email }}</td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{ route('admin.adminlecturer_edit') }}" class="mr-2">
